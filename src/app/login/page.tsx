...
function LoginPageContent() {
  ...
  // Redirect after a successful Google sign-in is handled by the
  // isAuthenticated/needsProfileCompletion useEffect above, same as password login.
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-6">
            ...
            <div className="relative mt-5 mb-1">
              ...
              <div className="relative flex justify-center text-xs"><span className="px-3 bg-white text-gray-400">or sign in with email</span></div>
            </div>
          </div>
